...
huntForSuifFile "05.docker-image-builders/MSR/1011/msr-as1-custom-builder-01" "Dockerfile" || exit 1
huntForSuifFile "05.docker-image-builders/MSR/1011/msr-as1-custom-builder-01" "install.sh" || exit 2

logI "Preparing the build context..."
mkdir /tmp/build_context

mv "${SUIF_CACHE_HOME}/05.docker-image-builders/MSR/1011/msr-as1-custom-builder-01/"* /tmp/build_context/
...
export JOB_CONTAINER_BASE_TAG="${MY_AZ_ACR_URL}/msr-1011-as1-custom-recipe1:Fixes_${SUIF_FIXES_DATE_TAG}"
